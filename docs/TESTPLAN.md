...
- Verify both portable executables start and show the correct `1.1.1` version.
- Verify `dist\installer\AIChatRTLFixerSetup-1.1.1.exe` and its `.sha256` file exist.
