...
- Verify both portable executables start and show the correct `1.1.0` version.
- Verify `dist\installer\AIChatRTLFixerSetup-1.1.0.exe` and its `.sha256` file exist.
