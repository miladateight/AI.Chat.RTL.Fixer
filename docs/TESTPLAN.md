...
- Verify both portable executables start and show the correct `1.0.6` version.
- Verify `dist\installer\AIChatRTLFixerSetup-1.0.6.exe` and its `.sha256` file exist.
