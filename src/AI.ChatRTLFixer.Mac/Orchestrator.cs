...
/// <summary>
/// Coordinates detection, CDP attachment and relaunch as a bounded per-process
/// state machine. Identical logic to the Windows tray's Orchestrator — this
/// class has no OS-specific code of its own; it only depends on the
/// IProcessWatcher/IRelaunchService abstractions implemented per-platform.
/// </summary>
