...
/// It never downloads or installs anything automatically, and sends no user,
/// device, chat, usage or diagnostic data.
/// </summary>
public sealed class UpdateChecker
{
    ...
    public static void OpenReleasePage(Uri releasePage)
    {
        ...
        System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo(releasePage.AbsoluteUri)
        {
